...
# --- THEME DESIGN SYSTEM (Soft Amethyst Purple (Light)) ---
BG = '#F5F3FF'
SURFACE = '#FFFFFF'
TEXT = '#3B0764'
MUTED = '#7C3AED'
...
FALLBACK_CERTIFICATES = ['Calculations with Vectors and Matrices.pdf', 'Core MATLAB Skills.pdf', 'Explore Data with MATLAB Plots.pdf', 'Machine Learning Onramp.pdf', 'Make and Manipulate Matrices.pdf', 'MATLAB Deskop Tools and Troubleshooting Scripts.pdf', 'MATLAB Desktop Tools and Troubleshooting Scripts.pdf', 'MATLAB Onramp.pdf', 'Simulink Onramp.pdf']
...
def main(page: ft.Page):
    page.title = "Amalia Mangundu - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Amalia Mangundu", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ft.Icon(ft.Icons.WORK_OUTLINE, size=15, color=MUTED),
                        ft.Text("Role: Frontend (Mining Department)", color=MUTED, size=14),
                        ft.Container(width=10),
                        ft.Icon(ft.Icons.EMAIL_OUTLINED, size=15, color=MUTED),
                        ft.Text("amaliamangundu@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/amaliamangundu-tech", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/components/AppButton.js', 'src/screens/ProfileScreen.js', 'src/screens/SettingsScreen.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Profile, settings, and reusable buttons.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Amalia Mangundu"\ngit config user.email "amaliamangundu@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Amalia Mangundu | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
